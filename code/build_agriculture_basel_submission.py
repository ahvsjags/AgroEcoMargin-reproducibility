...
def build_main() -> None:
    ...
    add_plain(doc, "Conceptualization, P.X., Y.C. and M.L.; Methodology, P.X., G.Z., G.Y. and Y.C.; Software, P.X.; Validation, P.X., G.Z. and G.Y.; Formal Analysis, P.X.; Investigation, P.X., G.Z. and G.Y.; Resources, G.Y., Y.C. and M.L.; Data Curation, P.X.; Writing - Original Draft Preparation, P.X.; Writing - Review and Editing, P.X., G.Z., G.Y., Y.C. and M.L.; Visualization, P.X.; Supervision, Y.C. and M.L.; Project Administration, P.X., Y.C. and M.L.; Funding Acquisition, M.L. P.X. and G.Z. contributed equally to this work and share first authorship. All authors have read and agreed to the published version of the manuscript.")
    ...
    add_plain(doc, "During preparation of this manuscript, the authors used OpenAI Codex (web application, accessed 12 July 2026) to assist with language editing, document formatting and reproducibility-workflow code refactoring. It was not used to generate or select study data, make analytical decisions, or interpret results. All outputs were reviewed and verified by the authors, who take full responsibility for the content of this publication.")
