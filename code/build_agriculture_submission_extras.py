...
def main() -> None:
    ...
    paragraph(doc, "The manuscript fits Agriculture because it addresses long-term agricultural-system management, nutrient response, water limitation, climate variability and reproducible assessment of digital-agriculture covariates. All figures are supplied as 600 dpi RGB PNG/TIFF files, and the accompanying archive contains processed analysis tables, figure-source data, bootstrap and permutation outputs, reproducible scripts and the pinned computing environment.")
